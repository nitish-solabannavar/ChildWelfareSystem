...
public class OrganizationDirectory {
    ...
    public Organization createOrganization(OrgType type){
        ...
        else if (type.getValue().equals(OrgType.FosterCare.getValue())){
            organization = new FosterCareOrganization();
            organizationList.add(organization);
        } 
        else if (type.getValue().equals(OrgType.Education.getValue())){
