 ...
 * @author nitis
 */
public class ManageRehabilationAdminJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageRehabilationAdminJPanel
     */
    private JPanel userProcessContainer;
    EcoSystem system;
    public ManageRehabilationAdminJPanel(JPanel userProcessContainer, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblNGOAdmin.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Country", "State", "City", "Rehabilation", "UserName"
            }
        ) {
        ...
        lblHeader.setText("Manage Rehabilation Admin");
    ...
    private void btnDeleteAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteAdminActionPerformed
        ...
        if(selectedRow >= 0){
            ...
            if(dialogResult == JOptionPane.YES_OPTION){
                RehabilationEnterprise e = (RehabilationEnterprise) tblNGOAdmin.getValueAt(selectedRow, 3);
                ...
                populateTable();
                JOptionPane.showMessageDialog(null, "Rehabilation admin deleted successfully","Warning", JOptionPane.WARNING_MESSAGE);
                                                    ...
                                                    for(Organization o: e.getOrganizationDirectory().getOrganizationList()){
                                                        if(o instanceof AdminOrganization){
                                                            ...
                                                            if(!o.getUserAccountDirectory().checkIfAdminExists(o)){
                                                                ...
                                                                // create admin org
                                                                JOptionPane.showMessageDialog(null, "Rehabilation admin added successfully", "Info", JOptionPane.INFORMATION_MESSAGE);

                                                            }else{
                                                                JOptionPane.showMessageDialog(null, "Rehabilation admin already exists", "Info", JOptionPane.INFORMATION_MESSAGE);
                                                            }
                                                        }
                                                    }
                                                }else{
