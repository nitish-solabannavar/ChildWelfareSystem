...
public class ViewResolvedIssuesStatisticsJPanel extends javax.swing.JPanel {
    ...
    private CategoryDataset createDataset() {
        ...
        hashmapResolved.put("Child Adoption", 0);
        ...
        hashmapOpen.put("Child Adoption", 0);
                                ...
                                if (organization instanceof ManagerOrganization) {
                                    for (WorkRequest request : organization.getWorkQueue().getWorkRequestList()) {
                                        if (!(request instanceof IssueWorkRequest)) {
                                            ...
                                            } else if (type.equals("Child Adoption")) {
                                                if (request.getStatus().equals("Resolved")) {
                                                    hashmapResolved.put("Child Adoption", hashmapResolved.get("Child Adoption") + 1);
                                                } else {
                                                    hashmapOpen.put("Child Adoption", hashmapOpen.get("Child Adoption") + 1);
                                                }
        ...
        dataset.setValue(hashmapResolved.get("Child Adoption"), series2, category3);
