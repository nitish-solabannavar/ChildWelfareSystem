 ...
 * @author nitis
 */
public class PublishRehabJobsJPanel extends javax.swing.JPanel {
    /**
     * Creates new form PublishRehabJobsJPanel
     */
    private JPanel userProcessContainer;
    private JobDirectory jobDirectory;
    private UserAccount userAccount;
    private EcoSystem system;
    public PublishRehabJobsJPanel(JPanel userProcessContainer, JobDirectory jobDirectory, UserAccount userAccount, EcoSystem system) {
        initComponents();
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (!name.equals("")) {
            ...
            if(name.equalsIgnoreCase("CareTaker") || name.equalsIgnoreCase("Educator")){
                for (Country c : system.getNetworkList()) {
                    for (State s : c.getStateList()) {
                ...
                JOptionPane.showMessageDialog(null, "Job can be posted for 'CareTaker' or 'Educator' position only", "Info", JOptionPane.INFORMATION_MESSAGE);
                return;        
            }
