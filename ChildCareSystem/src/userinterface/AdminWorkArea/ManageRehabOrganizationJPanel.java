 ...
 * @author nitis
 */
public class ManageRehabOrganizationJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageRehabOrganizationJPanel
     */
    private JPanel userProcessContainer;
    private OrganizationDirectory organizationDirectory;
    public ManageRehabOrganizationJPanel(JPanel userProcessContainer, OrganizationDirectory organizationDirectory) {
        initComponents();
    ...
    private void populateCombo() {
        ...
        for (Organization.OrgType type : Organization.OrgType.values()) {
            if (type.getValue().equals(Organization.OrgType.FosterCare.getValue()) || type.getValue().equals(Organization.OrgType.Education.getValue())) {
