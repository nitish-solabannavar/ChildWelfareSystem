 ...
 * @author vinod
 */
public class EducatorHomeJPanel extends javax.swing.JPanel {
    ...
    public EducatorHomeJPanel(JPanel mainContainer, EcoSystem system, DB4OUtil dB4OUtil, UserAccount userAccount, Organization organization, Enterprise enterprise) {
        initComponents();
        ...
        EducatorWorkAreaJPanel vwajp = new EducatorWorkAreaJPanel(userProcessContainer, system, userAccount, organization, enterprise);
