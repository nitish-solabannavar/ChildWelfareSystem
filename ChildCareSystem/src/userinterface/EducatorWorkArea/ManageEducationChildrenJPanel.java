 ...
 * @author nitis
 */
public class ManageEducationChildrenJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageEducationChildrenJPanel
     */
    ...
    public ManageEducationChildrenJPanel(JPanel userProcessContainer, EcoSystem system, UserAccount userAccount, Organization organization, Enterprise enterprise) {
        initComponents();
    ...
    public void populateAgencyTable() {
        ...
        for (WorkRequest request : organization.getWorkQueue().getWorkRequestList()) {
            if (request instanceof EducationChildrenWorkRequest) {
                if (((EducationChildrenWorkRequest) request).getChild().isStatus() == true) {
                    Object[] row = new Object[3];
                    row[0] = (EducationChildrenWorkRequest) request;
                    row[1] = ((EducationChildrenWorkRequest) request).getChild().getAge();
                    model.addRow(row);
                }
            }
        }
    ...
    private void initComponents() {
        ...
        lblHeader.setText("Manage Education Children");
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        ...
        EducationChildrenWorkRequest childRequest = (EducationChildrenWorkRequest) tblFundingAgency.getValueAt(selectedRow, 0);
        ...
        enterprise.getEducationChildrenDirectory().getEducationChildrenList().add(child);
        ...
        system.getEducationChildrenDirectory().createEducationChildren(childRequest.getChild().getName(), childRequest.getChild().getAge());
