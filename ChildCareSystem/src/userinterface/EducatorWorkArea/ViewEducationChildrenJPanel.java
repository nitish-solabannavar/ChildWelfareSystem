 ...
 * @author nitis
 */
public class ViewEducationChildrenJPanel extends javax.swing.JPanel {
    ...
    public ViewEducationChildrenJPanel(JPanel userProcessContainer, EcoSystem system, UserAccount userAccount, Organization organization, Enterprise enterprise) {
        initComponents();
    ...
    public void populateViewVolunteerTable() {
        ...
        model.setRowCount(0);
                for (EducationChildren child : enterprise.getEducationChildrenDirectory().getEducationChildrenList()) {
    ...
    private void initComponents() {
        ...
        lblHeader.setText("View School Children");
